...
FANTOMPATH = "/dors/capra_lab/projects/enhancer_ages/fantom/data/download/CL_0000182_hepatocyte_expressed_enhancers/non-genic/no-exon_CL_0000182/ages"
FANTOMFILE = "syn_breaks_no-exon_CL_0000182_ages.bed"

FANTOMPATH = "/dors/capra_lab/projects/enhancer_ages/fantom/data/HEPG2_FANTOM5_hg19/ages"
FANTOMFILE = "syn_breaks_HEPG2_FANTOM5_hg19_ages.bed"

FANTOM = os.path.join(FANTOMPATH, FANTOMFILE)

ENCODEPATH = "/dors/capra_lab/data/encode/encode3_hg38/TF/"
ENCODEFILE = "HepG2.liftOver.to.hg19.bed"

ENCODE = os.path.join(ENCODEPATH, ENCODEFILE)

INTERSECTIONFILE = "HepG2_FANTOM_x_ENCODE_hg19.bed"
...
df = df.loc[df.overlap >5] # removes 877 TF overlaps
