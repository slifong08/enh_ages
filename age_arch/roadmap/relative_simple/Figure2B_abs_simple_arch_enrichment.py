...
if CALCULATE_OR == 1:
    ...
    outf = "%sROADMAP_Shuf_summary_abs_simple_or.tsv" %path
...
plt.savefig("%sfig2b-ROADMAP_abs_age_seg_fold_change_matplotlib.pdf" %(RE), bbox_inches = "tight")
...
plt.savefig("%sROADMAP_enh_shuf_abs_simple_freq.pdf" % (RE), bbox_inches = "tight")
