...
def get_OR(final_merge, shuffle, seg_index, sid):
    ...
    "P": [P], "relative_simple_seg_index": [relative_simple],
     "seg_index":[seg_index], "unqkey":[unique_key]})
...
if CALCULATE_OR == 1:
    ...
    outf = "%sROADMAP_Shuf_global_summary_relative_simple_or.tsv" %path
    ...
    outf_seg = "%sROADMAP_Shuf_global_summary_seg_index_or.tsv" %path
