...
path = "/dors/capra_lab/projects/enhancer_ages/roadmap_encode/data/hg19_roadmap_samples_enh_age/download/h3k27ac_plus_h3k4me3_minus_peaks/trimmed/breaks/"
...
for f in noexon_fs:
    ...
    sid = ((f.split("/")[-1]).split("_")[1]).split("-")[-1]
    print(sid)
