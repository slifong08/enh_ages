...
ENHFILE = "GG-LL_species-specific_OCRs_rank/trimmed_291_GG-LL_species-specific_OCRs_rank/breaks/trimmed_291_GG-LL_species-specific_OCRs_rank_enh_age_arch_summary_matrix.bed"
...
# all other OCRs
SHUFPATH = os.path.join(ENHPATH, "GG-LL_subtract_species_specific_OCR/trimmed_291_GG-LL_subtract_species_specific_OCR/breaks/")
SHUFFILE = "trimmed_291_GG-LL_subtract_species_specific_OCR_enh_age_arch_summary_matrix.bed"

SHUFF = os.path.join(SHUFPATH, SHUFFILE)

# make a dir to save results

RE = os.path.join(ENHF.split("data/")[0], "results/trimmed_291/")
...
d = 78270
obs = [[a,b],[c,d]]
stats.fisher_exact(obs) # complex enhancers are depleted. (0.93905742948974, 0.00393204997192975)
