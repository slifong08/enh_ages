...
len(table) # 29120 core-derived pairs
len(table.enh_id.unique()) # 17443 complex enhancers
len(table_nonzerosyn.enh_id.unique()) # 8913 complex enhancers have both core and derived TFBS
table_nonzerosyn.shape # (12799, 3) core-derived pairs.
