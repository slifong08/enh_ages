...
CELL_LINES = ["K562", "GM12878", "HepG2", "MCF-7"]
...
def combine_files(cell_line, path, outpath):
    ...
    cmd = f"cat dELS_{cell_line}.bed dELS,CTCF-bound_{cell_line}.bed\
     pELS_{cell_line}.bed, pELS,CTCF-bound_{cell_line}.bed > {outfile}"
