...
datetime.now())
#%%
RE ="/dors/capra_lab/projects/enhancer_ages/fantom/results/for_publication/age_breaks/no_repeat/"
...
enh = "%sFANTOM_NOREPEAT_enh_age_arch_full_matrix.tsv" % path
summaryEnh = "%sFANTOM_NOREPEAT_enh_age_arch_summary_matrix.tsv" % path

shuf = "%sSHUFFLE_NOREPEAT_FANTOM_enh_age_arch_full_matrix.tsv" % path
summaryShuf = "%sSHUFFLE_NOREPEAT_FANTOM_enh_age_arch_summary_matrix.tsv" % path
