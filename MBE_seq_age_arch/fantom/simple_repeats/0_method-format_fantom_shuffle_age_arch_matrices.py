...
samples = glob.glob("%sno-repeats_temp_FANTOM_enh_age_arch_*.bed" % path)


shuffle_path = "/dors/capra_lab/projects/enhancer_ages/fantom/data/shuffle/breaks/no-repeats/"
shuffle_path = path
shuffle_files = glob.glob("%sno-repeats_shuf-*_age_breaks.bed" % path)
...
print(shuffle.shape)
out_shuf = "%sSHUFFLE_NOREPEAT_FANTOM_enh_age_arch_full_matrix.tsv" % path
...
out_enh_shufBreaks = "%sSHUFFLE_NOREPEAT_FANTOM_enh_age_arch_summary_matrix.tsv" % path
...
# save the file
out_enh = "%sFANTOM_NOREPEAT_enh_age_arch_full_matrix.tsv" % path
...
out_enh_breaks = "%sFANTOM_NOREPEAT_enh_age_arch_summary_matrix.tsv" % path
