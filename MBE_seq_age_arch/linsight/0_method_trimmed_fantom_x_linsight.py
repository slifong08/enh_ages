...
fantom_fs = ["%strimmed_all_unique_fantom_erna_112_tissue.bed" % fantom_path]

fantom_path = "/dors/capra_lab/projects/enhancer_ages/fantom/data/multiintersect/trimmed/"
fantom_fs = ["%strimmed_all_fantom_enh_112_tissues_multiintersect_0.5_count.bed"%fantom_path]
