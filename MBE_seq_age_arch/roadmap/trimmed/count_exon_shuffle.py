...
path = "/dors/capra_lab/projects/enhancer_ages/roadmap_encode/data/hg19_roadmap_samples_enh_age/download/h3k27ac_plus_h3k4me3_minus_peaks/trimmed/shuffle/breaks/non-genic/"



noexon_fs = glob.glob("%sno-exon_*.bed" % path)
wexon_fs = glob.glob("%sexonOverlap_*.bed" % path)
