...
path = "/dors/capra_lab/projects/enhancer_ages/roadmap_encode/data/hg19/download/h3k27ac_plus_h3k4me3_minus_peaks/non-genic/"

fs = glob.glob("%sbreaks/to_delete/no-exon_E*.bed" %path)
...
for sid in sid_list:
    ORdf, enhLens, enhFreq, enhSeg, enhProp, enhSegOR = get_data(sid, path, pdf)
